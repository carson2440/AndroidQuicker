...
/**
 * Created by carson on 2017/4/13.
 */
...
public class ViewDragHelper {
    ...
    public void removemIdleRunnable() {
        mParentView.removeCallbacks(this.mSetIdleRunnable);
    }
     ...
     */
    private static final Interpolator sInterpolator = new DecelerateInterpolator(3.0f);
...
//        mScroller = ScrollerCompat.create(context, sInterpolator);
     ...
     * The child order is determined using
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
